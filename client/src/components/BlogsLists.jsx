...
export default function BlogsLists () {
  return (
    <div className='w-3/5 mx-auto mt-9 xl:w-4/5 lg:w-full'>
      <Link to='/blogpost'>
        <div id='article1' className='flex flex-col items-center border-b-2 pb-11'>
      ...
      <div id='all__articles' className='w-3/5 mt-7 mx-auto md:w-full'>
        ...
        <div
          id='bloglists'
          className='mt-7 grid grid-cols-2 justify-center gap-6 gap-y-8 mb-20 md:grid-cols-1 md:justify-center md:bg-blue-400'
        >
          <Link to='/blogpost'>
            <Post />
          </Link>
